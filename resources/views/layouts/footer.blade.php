<footer class="text-sm leading-6 mt-8 px-3">
    <div class="pt-10 pb-10 border-t border-slate-200 sm:flex justify-between text-slate-500">
        <div class="mb-6 sm:mb-0 sm:flex">
            <p>Copyright © 2024 Kestory.</p>
            <p class="sm:ml-4 sm:pl-4 sm:border-l sm:border-slate-200"><a
                    class="hover:text-slate-900" href="/brand">Policy</a>
            </p>
        </div>
